...
<div class="admin-content">
  <div class="admin-content-body">
    ...
    <div class="am-tabs am-margin" data-am-tabs>
      ...
      <form action="<?php echo U('Index/add_job');?>" method="post">
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
          <div class="am-g am-margin-top">
            <div class="am-u-sm-4 am-u-md-2 am-text-right">招聘企业</div>
            <div class="am-form-group">
            <div class="am-u-sm-8 am-u-md-10">
                <input type="text" name="company_name" placeholder="招聘企业">
            </div>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-form-group">
            <div class="am-u-sm-8 am-u-md-10">
                <input type="text" name="job_name" placeholder="招聘职位">
            </div>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-form-group">
            <div class="am-u-sm-8 am-u-md-10">
                <input type="text" name="job_welf" placeholder="职位诱惑">
            </div>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-form-group">
            <div class="am-u-sm-8 am-u-md-10">
                <input type="text" name="price" placeholder="薪资范围">
            </div>
            </div>
          </div>
          <div class="am-g am-margin-top">
            ...
            <div class="am-form-group">
            <div class="am-u-sm-8 am-u-md-10">
                <input type="text" name="job_edu" placeholder="学历">
            </div>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-form-group">
            <div class="am-u-sm-8 am-u-md-10">
                <input type="text" name="city" placeholder="工作地址">
            </div>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-form-group">
            <div class="am-u-sm-8 am-u-md-10">
                <input type="text" name="job_number" placeholder="招聘人数">
            </div>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-form-group">
            <div class="am-u-sm-8 am-u-md-10">
                <input type="text" name="job_email" placeholder="投递邮箱">
            </div>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-12 am-u-md-10">
              <textarea name="job_desc" id="job_desc" style="width:800px;height:300px;"></textarea>  
            </div>
          </div>
          <div class="am-g am-margin-top-sm">
            <div class="am-u-sm-12 am-u-md-2 am-text-right admin-form-text">
            ...
            <div class="am-u-sm-12 am-u-md-10">
              <textarea name="job_req" id="job_req" style="width:800px;height:300px;"></textarea>  
            </div>
          </div>
        </div>
  ...
  <center>
    <div class="am-margin">
      <button type="submit" class="am-btn am-btn-primary am-radius">添加招聘</button>
    </div>
    </center>
      </form>
